...
SSH_HOST="ssh-laurent-busenhart.nona.company"
...
KESTRA_URL=https://kestra-laurent-busenhart.nona.company
EOF
...
CB_SERVER_URL=https://cloudbeaver-laurent-busenhart.nona.company
...
REDIRECT_URL=https://hoppscotch-laurent-busenhart.nona.company
WHITELISTED_ORIGINS=https://hoppscotch-laurent-busenhart.nona.company
VITE_BASE_URL=https://hoppscotch-laurent-busenhart.nona.company
VITE_SHORTCODE_BASE_URL=https://hoppscotch-laurent-busenhart.nona.company
VITE_ADMIN_URL=https://hoppscotch-laurent-busenhart.nona.company/admin
VITE_BACKEND_GQL_URL=https://hoppscotch-laurent-busenhart.nona.company/backend/graphql
VITE_BACKEND_WS_URL=wss://hoppscotch-laurent-busenhart.nona.company/backend/graphql
VITE_BACKEND_API_URL=https://hoppscotch-laurent-busenhart.nona.company/backend/v1
...
PREFECT_UI_API_URL=https://prefect-laurent-busenhart.nona.company/api
EOF
...
LAKEFS_GATEWAYS_S3_DOMAIN_NAME=s3.lakefs-laurent-busenhart.nona.company
...
NC_PUBLIC_URL=https://nocodb-laurent-busenhart.nona.company
                    ...
                    SECRETS_PAYLOAD=$(cat <<SECRETS_EOF
{
  ...
  "secrets": [
    ...
    {"secretKey": "GITEA_REPO_URL", "secretValue": "https://git-laurent-busenhart.nona.company/${ADMIN_USERNAME}/nexus-${DOMAIN//./-}-gitea.git", "tagIds": ["$GITEA_TAG"]},
    ...
    cron: \"*/15 * * * *\"'" >/dev/null 2>&1 || true
            ...
            if echo "$ENABLED_SERVICES" | grep -qw "woodpecker" && [ -n "$WOODPECKER_AGENT_SECRET" ]; then
                ...
                OAUTH_RESULT=$(ssh nexus "curl -s -X POST 'http://localhost:3200/api/v1/user/applications/oauth2' \
                    ...
                    -d '{
                        \"name\": \"Woodpecker CI\",
                        \"redirect_uris\": [\"https://woodpecker-laurent-busenhart.nona.company/authorize\"],
...
if echo "$ENABLED_SERVICES" | grep -qw "wikijs" && [ -n "$WIKIJS_ADMIN_PASS" ]; then
    (
        ...
        SETUP_PAYLOAD=$(jq -n \
            ...
            --arg url "https://wiki-laurent-busenhart.nona.company" \
